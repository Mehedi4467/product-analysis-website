...
const UserReviews = ({ user }) => {
    ...
    return (
        <div className='shadow-lg mb-4 flex-none md:flex items justify-round w-9/12 mx-auto py-5 px-5 rounded-lg hover:shadow-xl'>

            <div className='w-3/12'>
                <div className='flex justify-start md:justify-center items-center'>
                    <img className='rounded-lg ' src={image} width='100px' alt="" />
                </div>
                <p className='text-lg text-justify md:text-center mt-4 text-blue-500'>{name}</p>
            </div>
